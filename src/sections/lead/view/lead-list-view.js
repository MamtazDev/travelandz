...
import { _userList, _roles, PROVIDER_STATUS_OPTIONS } from "src/_mock";
...
const STATUS_OPTIONS = [{ value: "all", label: "All" }, ...PROVIDER_STATUS_OPTIONS];
...
export default function LeadListView() {
  ...
  const notFound = (!tableData.length && canReset) || !dataFiltered.length;
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.dashboard.providers.edit(id));
    },
    [router]
  );
      ...
      <Container maxWidth={settings.themeStretch ? false : "lg"}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: "Lead", href: paths.dashboard.providers.root },
            { name: "List" },
          ]}
          action={
            <Button
