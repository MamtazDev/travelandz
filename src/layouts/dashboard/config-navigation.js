      ...
      // ----------------------------------------------------------------------
      {
        ...
        items: [
          ...
          // TASK
          {
            ...
            icon: ICONS.user,
            // children: [
            //   { title: t('list'), path: paths.dashboard.task.list },
            // ],
          },
          // TOUR
          {
            ...
            children: [
              ...
              { title: t("createai"), path: paths.dashboard.tour.newai },
              { title: t("displayai"), path: paths.dashboard.tour.aitour },
          ...
          // {
          //   title: t('customer book'),
          //   path: paths.dashboard.client.book,
          //   icon: ICONS.folder,
          // },
          // PROJECT
          // {
          ...
          //   icon: ICONS.user,
          //   children: [{ title: t("list"), path: paths.dashboard.task.list }],
          // },
          // USER
          // {
          //   title: t("user"),
         ...
         /* {
            ...
            icon: ICONS.booking,
            children: [
              { title: t("profile"), path: paths.dashboard.providers.root },
              { title: t("cards"), path: paths.dashboard.providers.cards },
              { title: t("list"), path: paths.dashboard.providers.list },
              { title: t("create"), path: paths.dashboard.providers.new },
            //  { title: t("edit"), path: paths.dashboard.providers.demo.edit },
              { title: t("account"), path: paths.dashboard.providers.account },
            ],
          },*/
          // {
          //   title: t("customer"),
          ...
          //   icon: ICONS.user,
          //   children: [
          //     { title: t("profile"), path: paths.dashboard.customer.root },
          //     { title: t("cards"), path: paths.dashboard.customer.cards },
