...
const CustomerListPage = lazy(() =>
  import("src/pages/dashboard/customer/list")
);
...
// Providers
const ProvidersProfilePage = lazy(() =>
  import("src/pages/dashboard/providers/profile")
);
const ProvidersCardsPage = lazy(() =>
  import("src/pages/dashboard/providers/cards")
);
const ProvidersListPage = lazy(() =>
  import("src/pages/dashboard/providers/list")
);
const ProvidersAccountPage = lazy(() =>
  import("src/pages/dashboard/providers/account")
);
const ProvidersCreatePage = lazy(() =>
  import("src/pages/dashboard/providers/new")
);
const ProvidersEditPage = lazy(() =>
...
//TRAVEL
const TourAICreatePage = lazy(() => import("src/pages/dashboard/tour/newAI"));
const TourAIDisplayPage = lazy(() => import("src/pages/dashboard/tour/aitour"));
// AGENT VIEW
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: "profile/:projectId", element: <ProjectProfilePage /> },
      ...
      },
      {
        path: "providers",
        children: [
          { element: <ProvidersProfilePage />, index: true },
          { path: "profile", element: <ProvidersProfilePage /> },
          { path: "cards", element: <ProvidersCardsPage /> },
          { path: "list", element: <ProvidersListPage /> },
          { path: "new", element: <ProvidersCreatePage /> },
          { path: ":id/edit", element: <ProvidersEditPage /> },
          { path: "account", element: <ProvidersAccountPage /> },
        ],
      },
      {
        path: "leads",
        children: [
          ...
          { path: "profile", element: <LeadProfilePage /> },
      ...
      },
      {
        ...
        children: [
          ...
          { path: "newai", element: <TourAICreatePage /> },
          { path: "aitour", element: <TourAIDisplayPage /> },
