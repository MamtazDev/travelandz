...
export default function HomeDarkMode() {
  ...
  const renderDescription = (
    <Stack alignItems="center" spacing={3}>
      ...
      <m.div variants={varFade().inUp}>
        ...
        Effortless Travel Planning, Endless Possibilities
        </Typography>
      </m.div>

      <m.div variants={varFade().inUp}>
        <Typography sx={{ color: 'grey.500' }}>
        Seamlessly Create and Customize Dream Trips with Real-Time Choices
        </Typography>
      </m.div>
  ...
  const renderImg = (
    <m.div variants={varFade().inUp}>
      <Image
        alt="darkmode"
        src="/assets/images/home/hero/travelandz-B2.webp"
        sx={{
          borderRadius: 2,
          my: { xs: 5, md: 10 },
