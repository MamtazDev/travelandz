...
export default function HomeColorPresets() {
  ...
  const renderDescription = (
    <Stack spacing={3} sx={{ textAlign: 'center' }}>
      ...
      <m.div variants={varFade().inDown}>
        <Typography variant="h2"> Elevate Business Efficiency with Intelligent Tools </Typography>
      </m.div>

      <m.div variants={varFade().inDown}>
        <Typography sx={{ color: 'text.secondary' }}>
        Streamline Operations, Boost Revenue, and Cultivate Customer Relationships with Travelandz's Cutting-Edge CRM and Automation Solutions
        </Typography>
      </m.div>
    </Stack>
  );
