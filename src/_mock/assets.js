...
export const _postTitles = [
  'Harnessing AI: Revolutionizing Travel Planning',
  'The Future of Travel: A Digital Horizon',
  'Food Tourism: Savoring the World, One Bite at a Time',
  'Wellness Tourism: Balancing Adventure with Self-Care',
  'Digital Nomadism: Redefining Work and Travel',
  'Bleisure Travel: Merging Work and Play in a Single Journey!',
  "Solo Travel: Embrace the Freedom of Self-Discovery on Your Own Terms!",
...
export const _productNames = [
  'Hotel Marriot Madrid Booking',
  'Transfer from Airport to Hotel Marriot Madrid',
  'Activities Madrid City Tour',
