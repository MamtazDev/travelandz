            ...
            <Grid container  alignItems="flex-start" justifyContent="space-between">
                <Grid xs={12} md={10} lg={10} alignItems="start" display={'flex'}>
                    ...
                    <m.div >
                        ...
                        <h2 className='hero-heading'>Taylor made inspiring Spain</h2>
                    </m.div>
                </Grid>

                <Grid justifyContent={'start'} display={'block'} xs={12} md={2} lg={2} alignItems="center">
                    <Grid onClick={clearInput} display={'flex'} className='pointer' alignItems={'center'} justifyContent={'end'}>
                        <img src={reset} alt="reset" className='small-img' />
                        <p className='my-0 ms-2 reset'>Reset</p>
                    </Grid>
                    <div>
                    <TextField onChange={(e) => setEmail(e.target.value)} id="standard-basic" label="MAIL" variant="standard" defaultValue={email} />
